        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-8 col-12">
              ...
              <!-- Inicial -->
              <div class="row mb-3">
                <div class="col-lg-5 ms-lg-3 col-12 me-3 text-center text-lg-start">
                  <img
                  ...
                  <div class="row">
                    ...
                    >
                      <li class="d-flex flex-column">
                        ...
                        <strong style="font-size: 1rem">1946</strong>
                      </li>
                      <li class="d-flex flex-column">
                        <span>Fundador(a)</span>
                        <strong style="font-size: 1rem"
                          >Confederação Nacional do Comércio de Bens, Serviços e Turismo</strong
                        >
                      </li>
                      <li class="d-flex flex-column">
                        <span>Origem</span>
                          ...
                          <ul class="dropdown-menu" style="width:300px">
                            ...
                            <li>
                              <span class="dropdown-item">
                                <img class="img-fluid" src="../assets/img/graficos/senac.png" alt="Gráfico de Funcionarios do Atack">
                              </span>
                            </li>
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <p>
                          O Serviço Nacional de Aprendizagem Comercial (Senac) é uma instituição brasileira de
                          educação criada em 10 de janeiro de 1946 através do decreto-lei 8.621. É uma entidade
                          privada com fins públicos que recebe contribuição compulsória das empresas do comércio e
                          de atividades assemelhadas. A nível nacional é administrado pela Confederação Nacional do
                          Comércio.
                        </p>
                        <p>
                          Os primeiros cursos ofertados pelo SENAC foram em 1947, foi o curso de Praticante de
                          Comércio e o curso de Praticante de Escritório, destinado a jovens entre 14 e 18 anos. Já para
                          maiores de 18 anos, foram disponibilizados os cursos de Balconista de Tecidos, Calçados e
                          Ferragens, Arquivista e Caixa-Tesoureiro.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div id="redes" class="row">
                ...
                >
                  <div
                    ...
                    "
                  >
                    <a href="https://www.instagram.com/senac_amazonas/"
                  ...
                  <div
                    ...
                    "
                  >
                    <a href="https://api.whatsapp.com/send?phone=5508000928888">
                  ...
                  <!-- Site -->
                  <div
                    class="col-lg-3 col-8 text-center d-flex flex-column pt-3 pb-3"
                    style="
                      box-shadow: 0 1px 2px 0 rgba(60, 64, 67, 0.3),
                        0 1px 3px 1px rgba(60, 64, 67, 0.15);
                    "
                  >
                    <a href="https://am.senac.br"
              ...
              <div class="card text-center mb-3">
                ...
                <div class="card-body">
                  <img src="../assets/img/logos/senac.png" width="100rem" alt="Logomarca do Atack">
                  <p class="card-text">Visite a página de vagas!</p>
                  <a href="https://am.senac.br/institucional/trabalhe-conosco/" class="btn text-white" style="background:#0aaa9e">Acessar</a>
                </div>
              </div>
            </div>
            <!-- Sumario -->
