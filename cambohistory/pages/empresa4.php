          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-12">
                  ...
                  <div class="row">
                    ...
                    >
                      <li class="d-flex flex-column">
                        ...
                        <strong style="font-size: 1rem">1981</strong>
                      </li>
                      <li class="d-flex flex-column">
                        <span>Fundador</span>
                        <strong style="font-size: 1rem"
                          >Luiz Gastaldi Junior</strong
                        >
                      </li>
                      <li class="d-flex flex-column">
                        <span>Origem</span>
                          ...
                          <ul class="dropdown-menu" style="width:300px">
                            ...
                            <li>
                              <span class="dropdown-item">
                                <img class="img-fluid" src="../assets/img/graficos/novaera.png" alt="Gráfico de Funcionarios do Atack">
                              </span>
                            </li>
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <p>
                        O Mercantil Nova Era foi fundado em 11 de agosto de 1981 pelo empresário Luiz Gastaldi
                        Junior, em Ji-Paraná, no estado de Rondônia. Após quatro anos, a empresa instalou sua matriz
                        na capital Porto Velho, visando expandir seus negócios em todo o estado.
                        </p>
                        <p>
                        Nas décadas de 80 e 90, expandiu-se pela Região Norte, chegando à Manaus, que despertou a atenção de todo o
                        Brasil e do mundo para as atividades industriais e o desenvolvimento do comércio da cidade, o
                        que possibilitaram um crescimento econômico e populacional significativos no município. O
                        maior centro urbano de toda Região Norte contribuiu para que a cidade desenvolvesse um
                        mercado cada vez mais amplo e diversificado, exigente por meios de distribuição modernos e sempre mais eficientes e eficazes.
                        </p>
                        <p>
                        O Mercantil Nova Era buscou novamente a expansão de seus negócios, apostando na expansão interestadual, e, no ano de 1998, transferiu a sua matriz para Manaus, a capital do estado do Amazonas. Em 2004, uniu-se ao seleto grupo do DEC Brasil.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="accordion mb-3" id="accordionExample">
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <p>
                        Conquistar a satisfação dos clientes, colaboradores e fornecedores, prestando serviços de
                        qualidade, sendo referência em preços justo e no atendimento ao cliente, buscando o alcance
                        de novos mercados, conduzindo os negócios de maneira ética e com compromisso social.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="accordion mb-3" id="accordionExample">
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <p>
                          Ser uma instituição inovadora, que acompanhe as tendências de mercado, almejando um
                          processo contínuo de expansão, em busca do crescimento sustentável.
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="row accordion-body d-lg-flex">
                        ...
                        >
                        Ética, Responsabilidade social, Honestidade, Transparência, Compromisso e foco nos Stakeholders.
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div id="redes" class="row">
                ...
                >
                  <div
                    ...
                    "
                  >
                    <a href="https://www.instagram.com/super.novaera/"
                  ...
                  <div
                    ...
                    "
                  >
                    <a href="https://www.supernovaera.com.br"
              ...
              <div class="card text-center mb-3">
                ...
                <div class="card-body">
                  <img src="../assets/img/logos/novaera.png" width="100rem" alt="Logomarca do Atack">
                  <p class="card-text">Visite a página de vagas!</p>
                  <a href="https://sites.google.com/superatacadonovaera.com.br/talentos-nova-era/carreiras?authuser=0" class="btn text-white" style="background:#0aaa9e">Acessar</a>
                </div>
              </div>
            </div>
            <!-- Sumario -->
