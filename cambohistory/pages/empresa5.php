        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-8 col-12">
              ...
              <!-- Inicial -->
              <div class="row mb-3">
                <div class="col-lg-5 col-12 ms-lg-3 me-3 text-center text-lg-start">
                  <img
                  ...
                  <div class="row">
                    ...
                    >
                      <li class="d-flex flex-column">
                        ...
                        <strong style="font-size: 1rem">1938</strong>
                      </li>
                      <li class="d-flex flex-column">
                        <span>Fundador(a)</span>
                        <strong style="font-size: 1rem"
                          >Lee Byung-chul</strong
                        >
                      </li>
                      <li class="d-flex flex-column">
                        <span>Origem</span>
                          ...
                          <ul class="dropdown-menu" style="width:300px">
                            ...
                            <li>
                              <span class="dropdown-item">
                                <img class="img-fluid" src="../assets/img/graficos/samsung.png" alt="Gráfico de Funcionarios do Atack">
                              </span>
                            </li>
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <p>
                          A Samsung foi fundada por Lee Byung-chul em 1938 como uma trading company. Nas três
                          décadas seguintes, o grupo se diversificou em áreas como processamento de alimentos,
                          têxtil, seguros, valores mobiliários e varejo. A Samsung entrou no setor de eletrônicos no
                          final dos anos 1960 e nos setores de construção e construção naval em meados dos anos
                          1970; essas áreas impulsionariam seu crescimento subsequente.
                        </p>
                        <p>
                        Após a morte de Lee em
                        1987, a Samsung foi separada em quatro grupos de negócios - Grupo Samsung,
                        Grupo Shinsegae, Grupo CJ e Grupo Hansol. Desde 1990, a Samsung globalizou cada
                        vez mais suas atividades e eletrônicos; em particular, seus telefones celulares e
                        semicondutores se tornaram sua fonte de renda mais importante.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="accordion mb-3" id="accordionExample">
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <p>
                        A missão da Samsung é inspirar o mundo com inovações significativas, criando novas
                        possibilidades e enriquecendo a vida das pessoas. A empresa busca constantemente
                        desenvolver tecnologias inovadoras e produtos de alta qualidade para satisfazer as
                        necessidades e os desejos dos consumidores em todo o mundo.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="accordion mb-3" id="accordionExample">
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <p>
                        A visão da Samsung é ser uma líder global em inovação, trazendo novas ideias, tecnologias e
                        produtos para transformar positivamente a vida das pessoas e impulsionar o progresso da
                        sociedade. A empresa busca ser reconhecida como uma marca que promove mudanças
                        significativas e cria um futuro melhor para todos.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="row accordion-body d-lg-flex">
                        ...
                        >
                        A Samsung acredita que viver de acordo com valores sólidos é a chave para bons negócios. É
                        por isso que esses valores fundamentais, juntamente com um rigoroso código de conduta,
                        estão no centro de cada decisão que a empresa toma. Valorizando seus colaboradores,
                        clientes e parceiros, reconhecendo que são eles que impulsionam o sucesso da empresa
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div id="redes" class="row">
                ...
                >
                  <div
                    ...
                    "
                  >
                    <a href="https://www.instagram.com/samsungbrasil/"
              ...
              <div class="card text-center mb-3">
                ...
                <div class="card-body">
                  <img src="../assets/img/logos/samsung.png" width="100rem" alt="Logomarca do Atack">
                  <p class="card-text">Visite a página de vagas!</p>
                  <a href="https://www.samsung.com/br/about-us/careers/" class="btn text-white" style="background:#0aaa9e">Acessar</a>
                </div>
              </div>
            </div>
            <!-- Sumario -->
